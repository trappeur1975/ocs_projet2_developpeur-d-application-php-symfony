...
<div id="slider" class="big_section">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item <?php if( $i == 1 ){ echo 'active'; } $i++; ?>" style="background-image: url(<?php echo esc_url($image); ?>);">
				<img class="slide_image" src="<?php echo esc_url($image); ?>">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="slider_overlay_bg">
										...
										<a class="hotel-btn hotel-secondry animated fadeInDown" href="<?php echo esc_url( $hotelone_pbtn_link ); ?>"><?php echo wp_kses_post( $hotelone_pbtn_text ); ?></a>
										<!-- ------------------fin modifier par nicolas tchenio --------------------------- -->
