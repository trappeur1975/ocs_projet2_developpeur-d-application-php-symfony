...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog_post'); ?>>
	<?php $enableThumb = get_theme_mod('single_thumbnail',false); ?>
	<?php $enableMeta = get_theme_mod('single_meta',false); ?>
	<?php if ( '' !== get_the_post_thumbnail() && $enableThumb ) : ?>
	<div class="blog-mask">
