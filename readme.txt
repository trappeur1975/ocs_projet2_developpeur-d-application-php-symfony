projet2 "integrez un thème wordpress pour un client" du parcour openclassrooms "developpeur d'application php/symfony":
...
note: dans le chaletEtCaviar\wp-content\ai1wm-backups n a pas ete integré au site